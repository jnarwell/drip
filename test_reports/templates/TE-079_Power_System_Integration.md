...
- name: Mean Well RSP-10000-48
  ...
  part_number: TBD
- name: All Power Consumers
  id: ALL_POWER_CONSUMERS
  part_number: TBD
prerequisite_tests:
- TE-048
enables_tests: []
...
# Test Report: TE-079 - Power System Integration
...
### 1.1 Test Overview
- **Test ID**: TE-079
- **Test Name**: Power System Integration
- **Purpose**: Test all power consumers together
- **Type**: INTEGRATION
- **Duration**: 8.0 hours
...
| All Power Consumers | ALL_POWER_CONSUMERS | _[TBD]_ | _[Record S/N]_ |


### 1.3 Prerequisites
The following tests must be completed before this test:
- **TE-048**: Power Quality Analysis
...
| All Power Consumers | _[Status after test]_ | _[Any notes]_ |
