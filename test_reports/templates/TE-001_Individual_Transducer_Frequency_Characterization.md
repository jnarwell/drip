...
test_purpose: "Verify each transducer operates at 40kHz \xB1100Hz per SR001"
...
# Test Report: TE-001 - Individual Transducer Frequency Characterization
...
### 1.1 Test Overview
- **Test ID**: TE-001
- **Test Name**: Individual Transducer Frequency Characterization
- **Purpose**: Verify each transducer operates at 40kHz ±100Hz per SR001
- **Type**: ACCEPTANCE
- **Duration**: 3.0 hours
