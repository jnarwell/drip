...
# Test Report: TE-060 - Sensor Noise Characterization
...
### 1.1 Test Overview
- **Test ID**: TE-060
- **Test Name**: Sensor Noise Characterization
- **Purpose**: Measure noise floor of all sensors
- **Type**: PERFORMANCE
- **Duration**: 6.0 hours
...
- **TE-055**: Sensor Data Acquisition
