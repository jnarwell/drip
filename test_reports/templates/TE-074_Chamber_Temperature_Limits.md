...
test_purpose: "Verify chamber walls <300\xB0C per SR009"
verification_type: PERFORMANCE
components_verified:
- name: Aluminum Chamber Walls
  id: ALUMINUM_CHAMBER_WALLS
  part_number: TBD
- name: Ceramic Fiber Blanket
  id: CERAMIC_FIBER_BLANKET
  part_number: TBD
prerequisite_tests:
- TE-026
enables_tests: []
...
# Test Report: TE-074 - Chamber Temperature Limits
...
### 1.1 Test Overview
- **Test ID**: TE-074
- **Test Name**: Chamber Temperature Limits
- **Purpose**: Verify chamber walls <300°C per SR009
- **Type**: PERFORMANCE
- **Duration**: 6.0 hours
...
|-----------|----|--------------|--------------|
| Aluminum Chamber Walls | ALUMINUM_CHAMBER_WALLS | _[TBD]_ | _[Record S/N]_ |
| Ceramic Fiber Blanket | CERAMIC_FIBER_BLANKET | _[TBD]_ | _[Record S/N]_ |


### 1.3 Prerequisites
The following tests must be completed before this test:
- **TE-026**: Ceramic Insulation Performance
...
|-----------|--------------------|---------|
| Aluminum Chamber Walls | _[Status after test]_ | _[Any notes]_ |
| Ceramic Fiber Blanket | _[Status after test]_ | _[Any notes]_ |
