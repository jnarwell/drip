...
- name: Complete System
  id: COMPLETE_SYSTEM
  part_number: TBD
- name: HMI Touch Screen 15 inch
  id: HMI_TOUCH_SCREEN_15_INCH
  part_number: TBD
prerequisite_tests:
- TE-067
enables_tests: []
...
# Test Report: TE-098 - Operator Training Validation

## 1.0 Test Information

### 1.1 Test Overview
- **Test ID**: TE-098
- **Test Name**: Operator Training Validation
- **Purpose**: Verify system usability
- **Type**: ACCEPTANCE
- **Duration**: 16.0 hours
...
| HMI Touch Screen 15 inch | HMI_TOUCH_SCREEN_15_INCH | _[TBD]_ | _[Record S/N]_ |


### 1.3 Prerequisites
The following tests must be completed before this test:
- **TE-067**: HMI Interface Testing
...
| HMI Touch Screen 15 inch | _[Status after test]_ | _[Any notes]_ |
