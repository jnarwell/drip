...
- name: Aluminum Chamber Walls
  ...
  part_number: TBD
- name: Chamber Door Seals
  id: CHAMBER_DOOR_SEALS
  part_number: TBD
prerequisite_tests: []
enables_tests: []
...
# Test Report: TE-071 - Chamber Leak Test
...
### 1.1 Test Overview
- **Test ID**: TE-071
- **Test Name**: Chamber Leak Test
- **Purpose**: Verify chamber seal integrity
- **Type**: FUNCTIONAL
- **Duration**: 4.0 hours
...
| Chamber Door Seals | CHAMBER_DOOR_SEALS | _[TBD]_ | _[Record S/N]_ |
...
| Chamber Door Seals | _[Status after test]_ | _[Any notes]_ |
