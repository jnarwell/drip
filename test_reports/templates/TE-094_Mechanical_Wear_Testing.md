...
- name: Linear Actuators
  id: LINEAR_ACTUATORS
  part_number: TBD
- name: Dampers Motorized
  id: DAMPERS_MOTORIZED
  part_number: TBD
prerequisite_tests: []
enables_tests: []
estimated_duration: 500.0 hours
required_equipment:
- Cycle Counter
- Wear Gauge
status: NOT_STARTED
...
# Test Report: TE-094 - Mechanical Wear Testing

## 1.0 Test Information

### 1.1 Test Overview
- **Test ID**: TE-094
- **Test Name**: Mechanical Wear Testing
- **Purpose**: Assess moving parts durability
- **Type**: ENDURANCE
- **Duration**: 500.0 hours
...
|-----------|----|--------------|--------------|
| Linear Actuators | LINEAR_ACTUATORS | _[TBD]_ | _[Record S/N]_ |
| Dampers Motorized | DAMPERS_MOTORIZED | _[TBD]_ | _[Record S/N]_ |
...
|-----------|--------------------|---------|
| Linear Actuators | _[Status after test]_ | _[Any notes]_ |
| Dampers Motorized | _[Status after test]_ | _[Any notes]_ |
