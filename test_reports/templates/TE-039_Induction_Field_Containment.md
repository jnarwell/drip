...
components_verified:
- name: Induction Heater Module
  id: INDUCTION_HEATER_MODULE
  part_number: TBD
...
# Test Report: TE-039 - Induction Field Containment
...
### 1.1 Test Overview
- **Test ID**: TE-039
- **Test Name**: Induction Field Containment
- **Purpose**: Verify magnetic field safety limits
- **Type**: SAFETY
- **Duration**: 3.0 hours
...
|-----------|----|--------------|--------------|
| Induction Heater Module | INDUCTION_HEATER_MODULE | _[TBD]_ | _[Record S/N]_ |
| Magnetic Shielding | MAGNETIC_SHIELDING | _[TBD]_ | _[Record S/N]_ |
...
|-----------|--------------------|---------|
| Induction Heater Module | _[Status after test]_ | _[Any notes]_ |
| Magnetic Shielding | _[Status after test]_ | _[Any notes]_ |
