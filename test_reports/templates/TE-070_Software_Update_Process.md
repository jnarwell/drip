...
- name: Control System
  id: CONTROL_SYSTEM
  part_number: TBD
- name: STM32F7 Controllers
  id: STM32F7_CONTROLLERS
  part_number: TBD
- name: Raspberry Pi 4 8GB
  id: RASPBERRY_PI_4_8GB
  part_number: TBD
prerequisite_tests: []
enables_tests: []
...
# Test Report: TE-070 - Software Update Process
...
### 1.1 Test Overview
- **Test ID**: TE-070
- **Test Name**: Software Update Process
- **Purpose**: Verify OTA update capability
- **Type**: FUNCTIONAL
- **Duration**: 3.0 hours
...
| STM32F7 Controllers | STM32F7_CONTROLLERS | _[TBD]_ | _[Record S/N]_ |
| Raspberry Pi 4 8GB | RASPBERRY_PI_4_8GB | _[TBD]_ | _[Record S/N]_ |
...
| STM32F7 Controllers | _[Status after test]_ | _[Any notes]_ |
| Raspberry Pi 4 8GB | _[Status after test]_ | _[Any notes]_ |
