...
components_verified:
- name: Water Cooling Blocks
  id: WATER_COOLING_BLOCKS
  part_number: TBD
- name: Fittings 1/2 NPT to 3/8 Barb
  id: FITTINGS_1/2_NPT_TO_3/8_BARB
  part_number: TBD
prerequisite_tests:
- TE-024
enables_tests: []
...
# Test Report: TE-025 - Cooling System Leak Test
...
### 1.1 Test Overview
- **Test ID**: TE-025
- **Test Name**: Cooling System Leak Test
- **Purpose**: Verify all connections are leak-free
- **Type**: SAFETY
- **Duration**: 3.0 hours
...
|-----------|----|--------------|--------------|
| Water Cooling Blocks | WATER_COOLING_BLOCKS | _[TBD]_ | _[Record S/N]_ |
| Fittings 1/2 NPT to 3/8 Barb | FITTINGS_1/2_NPT_TO_3/8_BARB | _[TBD]_ | _[Record S/N]_ |


### 1.3 Prerequisites
The following tests must be completed before this test:
- **TE-024**: Cooling System Flow Rate
...
|-----------|--------------------|---------|
| Water Cooling Blocks | _[Status after test]_ | _[Any notes]_ |
| Fittings 1/2 NPT to 3/8 Barb | _[Status after test]_ | _[Any notes]_ |
