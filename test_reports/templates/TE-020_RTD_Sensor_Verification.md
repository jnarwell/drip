...
components_verified:
- name: RTD PT100 Sensors
  id: RTD_PT100_SENSORS
  part_number: TBD
prerequisite_tests: []
enables_tests: []
...
# Test Report: TE-020 - RTD Sensor Verification
...
### 1.1 Test Overview
- **Test ID**: TE-020
- **Test Name**: RTD Sensor Verification
- **Purpose**: Test PT100 RTD accuracy and response
- **Type**: ACCEPTANCE
- **Duration**: 4.0 hours
...
|-----------|----|--------------|--------------|
| RTD PT100 Sensors | RTD_PT100_SENSORS | _[TBD]_ | _[Record S/N]_ |
...
|-----------|--------------------|---------|
| RTD PT100 Sensors | _[Status after test]_ | _[Any notes]_ |
