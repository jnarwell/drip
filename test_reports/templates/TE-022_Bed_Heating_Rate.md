...
- name: Heated Build Platform
  ...
  part_number: TBD
- name: Silicon Heating Plates
  id: SILICON_HEATING_PLATES
  part_number: TBD
prerequisite_tests:
- TE-021
enables_tests: []
...
# Test Report: TE-022 - Bed Heating Rate

## 1.0 Test Information

### 1.1 Test Overview
- **Test ID**: TE-022
- **Test Name**: Bed Heating Rate
- **Purpose**: Measure time to reach operating temperature
- **Type**: PERFORMANCE
- **Duration**: 3.0 hours
...
| Silicon Heating Plates | SILICON_HEATING_PLATES | _[TBD]_ | _[Record S/N]_ |


### 1.3 Prerequisites
The following tests must be completed before this test:
- **TE-021**: Heated Bed Temperature Uniformity
...
| Silicon Heating Plates | _[Status after test]_ | _[Any notes]_ |
