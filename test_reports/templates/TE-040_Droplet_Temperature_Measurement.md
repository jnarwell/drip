...
# Test Report: TE-040 - Droplet Temperature Measurement
...
### 1.1 Test Overview
- **Test ID**: TE-040
- **Test Name**: Droplet Temperature Measurement
- **Purpose**: Validate pyrometer readings of droplets
- **Type**: FUNCTIONAL
- **Duration**: 4.0 hours
...
|-----------|----|--------------|--------------|
| Pyrometers | PYROMETERS | _[TBD]_ | _[Record S/N]_ |
...
|-----------|--------------------|---------|
| Pyrometers | _[Status after test]_ | _[Any notes]_ |
