...
# Test Report: TE-037 - Multi-Material Capability
...
### 1.1 Test Overview
- **Test ID**: TE-037
- **Test Name**: Multi-Material Capability
- **Purpose**: Test switching between Al and Steel
- **Type**: FUNCTIONAL
- **Duration**: 6.0 hours
...
- **TE-033**: Droplet Generation Consistency
- **TE-035**: Material Feed System
