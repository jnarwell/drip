...
components_verified:
- name: Material Wire Feeders
  id: MATERIAL_WIRE_FEEDERS
  part_number: TBD
...
# Test Report: TE-035 - Material Feed System

## 1.0 Test Information

### 1.1 Test Overview
- **Test ID**: TE-035
- **Test Name**: Material Feed System
- **Purpose**: Test wire feeder operation and control
- **Type**: FUNCTIONAL
- **Duration**: 4.0 hours
...
|-----------|----|--------------|--------------|
| Material Wire Feeders | MATERIAL_WIRE_FEEDERS | _[TBD]_ | _[Record S/N]_ |
...
|-----------|--------------------|---------|
| Material Wire Feeders | _[Status after test]_ | _[Any notes]_ |
