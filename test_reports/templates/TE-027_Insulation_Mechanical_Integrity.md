...
- name: Ceramic Fiber Blanket
  ...
  part_number: TBD
- name: Ceramic Insulation Plates
  id: CERAMIC_INSULATION_PLATES
  part_number: TBD
prerequisite_tests:
- TE-026
enables_tests: []
...
# Test Report: TE-027 - Insulation Mechanical Integrity
...
### 1.1 Test Overview
- **Test ID**: TE-027
- **Test Name**: Insulation Mechanical Integrity
- **Purpose**: Verify insulation withstands thermal cycling
- **Type**: ENDURANCE
- **Duration**: 24.0 hours
...
| Ceramic Insulation Plates | CERAMIC_INSULATION_PLATES | _[TBD]_ | _[Record S/N]_ |
...
| Ceramic Insulation Plates | _[Status after test]_ | _[Any notes]_ |
