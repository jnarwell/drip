...
test_purpose: "Verify \xB15\xB0C uniformity across build surface"
verification_type: PERFORMANCE
components_verified:
- name: Heated Build Platform
  id: HEATED_BUILD_PLATFORM
  part_number: TBD
- name: Temperature Controllers
  id: TEMPERATURE_CONTROLLERS
  part_number: TBD
prerequisite_tests:
- TE-019
enables_tests: []
...
# Test Report: TE-021 - Heated Bed Temperature Uniformity
...
### 1.1 Test Overview
- **Test ID**: TE-021
- **Test Name**: Heated Bed Temperature Uniformity
- **Purpose**: Verify ±5°C uniformity across build surface
- **Type**: PERFORMANCE
- **Duration**: 6.0 hours
...
|-----------|----|--------------|--------------|
| Heated Build Platform | HEATED_BUILD_PLATFORM | _[TBD]_ | _[Record S/N]_ |
| Temperature Controllers | TEMPERATURE_CONTROLLERS | _[TBD]_ | _[Record S/N]_ |
...
|-----------|--------------------|---------|
| Heated Build Platform | _[Status after test]_ | _[Any notes]_ |
| Temperature Controllers | _[Status after test]_ | _[Any notes]_ |
