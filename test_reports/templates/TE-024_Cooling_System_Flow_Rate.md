...
# Test Report: TE-024 - Cooling System Flow Rate

## 1.0 Test Information

### 1.1 Test Overview
- **Test ID**: TE-024
- **Test Name**: Cooling System Flow Rate
- **Purpose**: Verify required flow rates to all components
- **Type**: FUNCTIONAL
- **Duration**: 2.0 hours
...
| Flow Regulators | FLOW_REGULATORS | _[TBD]_ | _[Record S/N]_ |
...
| Flow Regulators | _[Status after test]_ | _[Any notes]_ |
