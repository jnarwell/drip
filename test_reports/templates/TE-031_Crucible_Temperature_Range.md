...
test_purpose: "Verify 700-1580\xB0C operation per SR003"
...
# Test Report: TE-031 - Crucible Temperature Range
...
### 1.1 Test Overview
- **Test ID**: TE-031
- **Test Name**: Crucible Temperature Range
- **Purpose**: Verify 700-1580°C operation per SR003
- **Type**: PERFORMANCE
- **Duration**: 8.0 hours
