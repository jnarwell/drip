...
test_purpose: "Confirm >1000\xB0C/s cooling per SR010"
...
# Test Report: TE-083 - Cooling Rate Verification

## 1.0 Test Information

### 1.1 Test Overview
- **Test ID**: TE-083
- **Test Name**: Cooling Rate Verification
- **Purpose**: Confirm >1000°C/s cooling per SR010
- **Type**: PERFORMANCE
- **Duration**: 6.0 hours
...
- **TE-040**: Droplet Temperature Measurement
