...
components_verified:
- name: Accelerometers 3-axis
  id: ACCELEROMETERS_3-AXIS
  part_number: TBD
prerequisite_tests: []
enables_tests: []
...
# Test Report: TE-052 - Accelerometer Characterization
...
### 1.1 Test Overview
- **Test ID**: TE-052
- **Test Name**: Accelerometer Characterization
- **Purpose**: Verify vibration measurement capability
- **Type**: FUNCTIONAL
- **Duration**: 3.0 hours
...
|-----------|----|--------------|--------------|
| Accelerometers 3-axis | ACCELEROMETERS_3-AXIS | _[TBD]_ | _[Record S/N]_ |
...
|-----------|--------------------|---------|
| Accelerometers 3-axis | _[Status after test]_ | _[Any notes]_ |
