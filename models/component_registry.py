    ...
    def _initialize_components(self):
        ...
        self.components.extend([
            ...
            Component(
                ...
                category=ComponentCategory.CRUCIBLE,
                type=ComponentType.COTS,
                specification="120V 40W cartridge, 6mm×20mm",
                quantity=25,
                unit_cost=8,
                total_cost=200,
                notes="Feed line heating - AC powered",
                requires_expansion=False,
                expansion_notes="",
                tech_specs=TechnicalSpecs(
                    power_consumption=40,  # W per heater
                    power_type='AC',  # AC powered at 120V
                    power_voltage=120,  # 120V AC
                    voltage_nominal=120,
                    current_draw=0.33,  # A per heater at 120V
