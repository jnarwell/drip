# ICD-008: Acoustic Array Phasing Interface
...
- **Purpose**: Define interface between Acoustic Cylinder Subsystem and Power/Control Subsystem
- **Interface Types**: electrical, data
- **Side A Components**: Transducer Array, Phase Shifters
- **Side B Components**: FPGA Board, DAC Array
...
**Critical Issues:**
- ❌ Insufficient power supply: 2W demand vs 0W supply
